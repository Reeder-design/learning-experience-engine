(() => {
  const GUIDE = '../user-guide/index.html';
  const topics = {
    choose: {
  ...
  function createPopover() {
    ...
    popover.innerHTML = `<div class="help-popover-head"><h3 data-help-title></h3><button type="button" class="help-popover-close" aria-label="Close help">×</button></div><p data-help-body></p><a data-help-link href="${GUIDE}">Open User Guide →</a>`;
