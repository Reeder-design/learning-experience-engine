...
function usage() {
  console.log(`\nWeb Builder v${BUILDER_VERSION}\n\nUsage:\n  node builders/web/index.js <normalized-course-folder> --output <folder>\n\nExample:\n  node builders/web/index.js ../learning-content-private/exports/pcn-rise-extracted/normalized --output ../learning-content-private/exports/pcn-web-preview\n`);
}
...
function main() {
  ...
  try {
    ...
    console.error(`\nError: normalized JSON could not be read.\n${error.message}\n`);
    process.exit(1);
  }
  ...
  console.log(`Media files available: ${assetsAvailable ? 'yes' : 'no (placeholders will be shown)'}`);
  console.log('\nCreated:');
